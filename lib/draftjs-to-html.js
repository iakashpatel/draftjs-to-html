(function (global, factory) {
  ...
  */
    ...
    if (inlineStyleRanges && inlineStyleRanges.length > 0) {
      inlineStyleRanges.forEach(function (range) {
        ...
        for (var i = offset; i < length; i += 1) {
          ...
          } else if (range.style.indexOf("padding-") === 0) {
            inlineStyles.PADDING[i] = range.style.substring(8);
  ...
  function getStylesAtOffset(inlineStyles, offset) {
    ...
    if (inlineStyles.PADDING[offset]) {
      styles.PADDING = inlineStyles.PADDING[offset];
    }
  ...
  function addStylePropertyMarkup(styles, text) {
    if (styles && (styles.COLOR || styles.BGCOLOR || styles.FONTSIZE || styles.FONTFAMILY || styles.PADDING)) {
      ...
      if (styles.PADDING) {
        styleString += "padding: ".concat(styles.PADDING).concat(/^\d+$/.test(styles.PADDING) ? "px" : "", ";");
      }
  ...
  */
  ...
  function getSectionMarkup(block, entityMap, section, customEntityTransform) {
    ...
    var inlineStyleSections = getInlineStyleSections(block, ["COLOR", "BGCOLOR", "FONTSIZE", "FONTFAMILY", "PADDING"], section.start, section.end);
